...
const AboutSection = () => {
  ...
  const testimonials = [
  {
    text: "Would highly recommend, quick fast honest & reliable garage, kept me updated about my car, will be returning if I have any more work doing to my car, Thanks the drs orders",
    name: "chris daniel",
  },
